...
<template>
  <div>
    ...
    >
      ...
      <el-table-column sortable prop="deptName" label="企业名称" width="200">
      </el-table-column>
      <el-table-column sortable prop="deptNo" label="企业编号" width="150">
      </el-table-column>
      <el-table-column sortable prop="deptAdd" label="企业位置" width="100">
      </el-table-column>
      <el-table-column sortable prop="deptType" label="企业类型" width="130">
      </el-table-column>
    ...
    >
      ...
      >
        ...
        <el-form-item label="企业编号" prop="deptNo">
          <el-input
            size="small"
         ...
         <el-form-item label="企业地址" prop="deptAdd">
          <el-input
            size="small"
            v-model="editForm.deptAdd"
            auto-complete="off"
            placeholder="请输入企业地址"
          ></el-input>
        </el-form-item>
