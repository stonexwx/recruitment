<template>
  <div class="job-recommend-box">
    ...
    <el-table :data="enterpriselist" @row-click="enterpriseDetail" stripe style="width: 80%">
      <el-table-column prop="number" label="排名" width="180" />
      <el-table-column prop="ename" label="公司名称" width="400" />
      <el-table-column prop="address" label="地址" width="300"/>
      <el-table-column prop="eva_scale" label="好评率" />
    </el-table>
  </div>
</template>
